...
import { PlasmicCompletedRating } from "./plasmic/play_plasmic_levels_start_here/PlasmicCompletedRating";

function CompletedRating(props) {
  ...
  return <PlasmicCompletedRating {...props} />;
}
