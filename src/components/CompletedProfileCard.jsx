...
import { PlasmicCompletedProfileCard } from "./plasmic/play_plasmic_levels_start_here/PlasmicCompletedProfileCard";

function CompletedProfileCard(props) {
  ...
  return <PlasmicCompletedProfileCard {...props} />;
}
