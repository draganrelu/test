...
import { PlasmicCompletedTweet } from "./plasmic/play_plasmic_levels_start_here/PlasmicCompletedTweet";

function CompletedTweet(props) {
  ...
  return <PlasmicCompletedTweet {...props} />;
}
